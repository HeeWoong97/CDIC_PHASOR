...
std::string YOLO_CFG_PATH = "./opencv/face-yolov3-tiny.cfg";
std::string YOLO_WEIGHT_PATH = "./opencv/face-yolov3-tiny_41000.weights";
std::string YOLO_NAME_PATH = "./opencv/coco.names";
