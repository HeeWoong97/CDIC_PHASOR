...
std::string YOLO_CFG_PATH = "./opencv/cfg/phasor-gray-train-yolo-v3.cfg";
std::string YOLO_WEIGHT_PATH = "./opencv/weight/phasor-gray-train-yolo-v3_final.weights";
std::string YOLO_NAME_PATH = "./opencv/name/phasor-classes.names";
